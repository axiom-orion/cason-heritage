# Public record audit — 2026-07-29
...
- **`agent-roster-count`** (profile.html) — drifted-value-needs-review: published value is `15` but the source now reads `17`

## Every claim

| claim | kind | visibility | check | result |
|---|---|---|---|---|
| `cognigate-latency` | metric | public | attested | ✅ allow · ok |
| `livekit-pr-6474` | status | public | github-issue-state | ✅ allow · skipped (offline) |
| `livekit-issue-6473` | status | public | github-issue-state | ✅ allow · skipped (offline) |
...
| `npm-basis-spec` | status | public | npm-package | ✅ allow · skipped (offline) |
| `site-vorion` | link | public | http-ok | ✅ allow · skipped (offline) |
| `site-cognigate` | link | public | http-ok | ✅ allow · skipped (offline) |
| `site-bai-cc` | link | public | http-ok | ✅ allow · skipped (offline) |
| `site-beodraft` | link | public | http-ok | ✅ allow · skipped (offline) |
...
| `role-vorion` | narrative | public | unverified | ✅ allow · declared uncheckable |
...
| `agent-roster-count` | metric | public | file-count | ⚠ review · 17 (published: 15) |
