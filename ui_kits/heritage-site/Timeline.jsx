...
const generations = [
  ...
  { side: 'left', variant: 'gap', badge: 'UNSOLVED — DNA NEEDED', number: 'Generation 5 — The Missing Link', name: 'James Cason (c.1727) or Henry Cason (c.1732)', dates: 'c.1727 – ?', location: 'Pitt County, North Carolina', detail: 'James is the leading candidate — no land records, "James Cason Jr." appears as Ransom\'s brother. Henry is secondary — right location, but his 1823 deeds show a separate local branch. Y-DNA testing is the path to certainty.' },
