...
const CASON_DATA = {
  ...
  people: {
    ...
    'moses': { id: 'moses', generation: 7, name: 'Moses Cason', parents: ['ransom-sr','phoebe-munden'], direct: false, evidence: 'confirmed', narrative: 'Farmer. Survived a Seminole attack in 1842. Bought about 160 acres by cash entry in 1848 — the SE quarter of Section 12, Township 7 South, Range 18 East, near Newnansville (Alachua Co.) — part of the cluster of Ransom Sr.\'s sons spread across Township 7 South.', sources: ['BLM-GLO patent, accession STA-FL0350__.152 (Document ID 5435420655802745691) — Moses Cason, Cash Entry, 159.67 ac, SE¼ Sec.12 T7S R18E, Newnansville land office, patented 1 Jul 1848 (PRIMARY)'] },
