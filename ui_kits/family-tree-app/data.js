...
const CASON_DATA = {
  ...
  people: {
    ...
    'james-green': {
      ...
      direct: true, evidence: 'confirmed',
      narrative: 'Born in Georgia c.1800, he was one of the children Ransom Sr. brought south through the Okefenokee in 1823 — so the family\'s Florida-born line begins not with him but with his son, Lt. Ransom "2" (1835). Married Lucinda "Lucy" Barrow. At least nine children. His father arrived when Alachua County had 300 people; by 1878, thousands. James Green\'s generation turned a homestead into a community. He held the family farm in Section 5, Township 7 South, Range 19 East, north of Newnansville — adding a 40-acre federal bounty-land warrant (#1769, NE¼ SW¼ Sec. 5, issued 7 Oct 1854) for Seminole-War service; his will (12 Jul 1878, Alachua Will Book C, pp.15–16) left the Section-5 land to wife Lucy for life, then to their daughter Rebecca, his executor.',
      sources: ['BLM GLO Military Bounty Land Warrant #1769 — NE¼ SW¼ Sec.5 T7S R19E, 7 Oct 1854 (PRIMARY)', 'Alachua Co. Will Book C, pp.15–16 — will 12 Jul 1878 (PRIMARY)', 'Huxford, Pioneers of the Wiregrass GA Vol. II p.86 (derivative)'],
    ...
    'casey-ann': { id: 'casey-ann', generation: 8, name: 'Casey Ann', role: '1st wife of Lt. Ransom', lifespan: '? – 1871', spouse: ['ransom-2'], children: ['thadeous'], direct: false, evidence: 'secondary', notes: 'LEAD (derivative — verify): a reading of the 1875 Florida census gives her maiden name as Cason and her father as Berrien Cason (a 2nd-Seminole-War veteran), which would make her marriage to Lt. Ransom a Cason–Cason cousin match (frontier endogamy — plausible for the time). A second thread now identifies that Berrien as Berrien Cason (Sr.), husband of Phoebe Cason (Ransom’s daughter) — which would make Casey Ann a granddaughter of Ransom Sr., sister of Berrien Jr. (1839), and Thadeous doubly descended from Ransom. Compelling but still derivative — flagged, not hard-wired into her parents.' },
    ...
    'carl-columbus': {
      ...
      notes: 'Verified (secondary — DuBose compiled genealogy / TNG database): b. 11 Aug 1903, Columbia Co.; m. Wilma Frances Douglas 27 Jan 1927, Columbia Co.; d. 22 Nov 1966, Columbia Co.; buried Shiloh Baptist Church Cemetery, Fort White. To confirm against the death certificate and the 1910/1920 census of Thadeous\'s Fort White household (which should also place Carl as Thadeous\'s son — see open lines).',
      sources: ['DuBose compiled genealogy (TNG database) — Carl Columbus Cason, b. 11 Aug 1903, m. Wilma Frances Douglas 27 Jan 1927, d. 22 Nov 1966, Columbia Co., FL; buried Shiloh Baptist Church Cemetery (secondary; cites DuBose Genealogy Sup. I, 1975)'],
    },
