...
const CASON_DATA = {
  ...
  people: {
    ...
    'phoebe-c': { id: 'phoebe-c', generation: 7, name: 'Phoebe Cason', parents: ['ransom-sr','phoebe-munden'], spouse: ['john-r-cason'], direct: false, evidence: 'secondary', narrative: 'Daughter of Ransom Sr. She married John R. Cason — her first cousin, son of Ransom’s brother Eli — a documented Cason–Cason cousin marriage tying the brothers’ lines (per Bo Williams / family sketches).' },
    'john-r-cason': { id: 'john-r-cason', generation: 7, name: 'John R. Cason', role: 'son of Eli; m. his cousin Phoebe Cason', lifespan: 'b. 1817', parents: ['eli-cason'], spouse: ['phoebe-c'], direct: false, evidence: 'secondary', narrative: 'Son of Eli Cason (Ransom Sr.’s brother); married his first cousin Phoebe Cason, daughter of Ransom Sr. — frontier endogamy joining the two brothers’ families. Per Bo Williams / Wiregrass family sketches.', tags: ['branch','secondary','endogamy'] },
