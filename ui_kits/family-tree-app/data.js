...
const CASON_DATA = {
  ...
  people: {
    ...
    'james-green': {
      ...
      sources: ['BLM-GLO patent, accession STA-FL0360__.026 (Document ID 8847978493370827352) — James Cason, Cash Entry, 40 ac, NW¼SE¼ Sec.5 T7S R13E, Newnansville land office, patented 15 May 1852 (PRIMARY, verified on GLO)', 'BLM GLO Military Bounty Land Warrant #1769 — NE¼ SW¼ Sec.5 T7S R19E, 7 Oct 1854 (cited; range not yet re-verified against GLO — see notes)', 'Alachua Co. Will Book C, pp.15–16 — will 12 Jul 1878 (PRIMARY)', 'Huxford, Pioneers of the Wiregrass GA Vol. II p.86 (derivative)'],
      notes: 'LAND — GLO-verified: a 40-acre cash entry at NW¼SE¼ Sec.5 T7S R13E, patented 15 May 1852 (accession STA-FL0360__.026), Newnansville office — attributed to James Green (the Newnansville James Cason, aged 52 in 1852). DISCREPANCY TO RESOLVE: this GLO record is in Range 13E, but the warrant #1769 cited here is placed at Range 19E (Sec.5, 1854) — the range adjacent to brother Ransom Jr.\'s Sec.6 T7S R19E. Confirm on GLO whether James held BOTH parcels (R13E cash 1852 + R19E warrant 1854) or whether the R19E/#1769 citation is mis-recorded. NAMING LEAD: the middle name "Green" almost certainly preserves a maternal surname (a near-universal 18th–19th-c. Southern custom), pointing to a Green in Ransom Sr.\'s mother\'s line or the Munden line — a concrete un-bricking target (Greens of Pitt/Beaufort/Craven Co. NC and Princess Anne Co. VA). Separately, that Ransom named a son "James" supports a father named James.',
    },
